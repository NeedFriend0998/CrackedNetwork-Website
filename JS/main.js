...
// ========== CONFIGURATION ==========
        ...
        const gamemodes = [
            ...
            { name: "Bedwars", tag: "PvP / Team", desc: "Protect your bed and destroy your enemies' beds! An exciting and thrilling team PvP game.", features: ["Solo/Duo/Trio/Squad", "Ranked Mode", "Custom Maps", "Stats Tracking", "Leaderboards", "Custom Resources Pack with sounds"], icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M2 4v16h20V4H2zm0 8h20M12 4v8"/></svg>' },
            { name: "Who's Lying", tag: "Betrayal", desc: " ", features: ["Vote Players", "Leaderboards", "Voice Chat"], icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M2 4v16h20V4H2zm0 8h20M12 4v8"/></svg>' },
...
document.addEventListener('keydown', e => {
    ...
    // Hindari key repeat spam (hanya terima saat tombol benar-benar ditekan, bukan hold)
    if (e.repeat) return;
    const idx = getCurrentPageIndex();
    if (idx === -1) return;
