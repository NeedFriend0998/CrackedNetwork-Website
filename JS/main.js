// ========== CONFIGURATION ==========
            ...
            bedwars: [
                ...
                },
                {
                    ...
                    features: [
                      ...
                      "Game Mode Voting (Normal / Generator Boost) ( Coming Soon )"
                      ]
                },
                {
                    id: "1518006",
        ...
        const gamemodes = [
            { name: "Survival ( Coming Soon )", tag: "PvE / Economy", desc: "Classic survival mode with economy, land claim, and active community features. Build bases, farm, and trade with other players.", features: ["Land Claim", "Economy", "Custom Enchants", "Player Shops", "Jobs"], icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/></svg>' },
            ...
            { name: "Hide And Seek ( Coming Soon )", tag: "Mini Game", desc: "Hide as a block or search for the hiders! A fun casual game to relax with friends.", features: ["Block Disguise", "Props", "Multiple Maps", "Taunts", "Effects"], icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4M12 8h.01"/></svg>' }
        ];
